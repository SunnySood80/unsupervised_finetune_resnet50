...
def load_processed_samples(h5_path: str = '/home/sks6nv/Projects/PPO/unsupervised_finetune_resnet50-SAM2/cursor_ppo/processed_samples_color_only.h5') -> List[List[np.ndarray]]:
    """
